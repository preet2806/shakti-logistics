    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-900 text-white p-12 rounded-[4rem] relative overflow-hidden shadow-3xl">
         ...
         <div className="relative z-10 max-w-2xl">
            ...
            <h2 className="text-4xl font-black mb-6 tracking-tighter leading-none uppercase">Reporting Standards</h2>
            <p className="text-slate-400 text-lg mb-10 font-medium leading-relaxed">
              Our expanded row format ensures that trips with multiple drops are clearly represented. Primary identifying info (Date, Tanker, Product) is only displayed on the first row of a trip for visual clarity in Excel.
            </p>
            <div className="flex flex-wrap gap-6">
              <div className="px-8 py-3 bg-slate-800 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 border border-slate-700">
